...
Device.create(name: 'PC6248-1', ip: '192.168.53.1', mac: '00-25-64-2a-c3-91', description: 'Management network, switch 1', device_type_id: 2)
Device.create(name: 'PC6248-2', ip: '192.168.53.2', mac: 'a4-ba-db-76-64-82', description: 'Management network, switch 2', device_type_id: 2)
Device.create(name: 'PC8024', ip: '192.168.53.3', mac: 'd0-67-e5-a5-1e-4b', description: 'iSCSI switch, Ports 1-8 FD1 / 9-24 FD2 (+ EQL)', device_type_id: 1)
Device.create(name: 'N2024', ip: '192.168.53.4', mac: 'f8-b1-56-42-be-53', description: 'Ports 3-4 to VRTX', device_type_id: 7)
Device.create(name: 'VRTX-Switch', ip: '192.168.53.11', mac: 'f8-b1-56-49-82-59', description: 'Ports 0/1-2 to N2024', device_type_id: 6)
Device.create(name: 'VRTX-CMC', ip: '192.168.53.10', mac: 'e0-db-55-fe-c3-3d', description: '', device_type_id: 4)
Device.create(name: 'VRTX-M630-1', ip: '192.168.53.12', mac: '10-98-36-9d-49-73', description: '', device_type_id: 5)
Device.create(name: 'VRTX-M630-2', ip: '192.168.53.13', mac: '10-98-36-9d-27-65', description: '', device_type_id: 5)
Device.create(name: 'R510-1', ip: '192.168.53.30', mac: '78-2b-cb-0a-ff-0c', device_type_id: 3)
Device.create(name: 'R510-2', ip: '192.168.53.31', mac: '78-2b-cb-04-d4-ea', device_type_id: 3)
Device.create(name: 'R510-3', ip: '192.168.53.32', mac: '78-2b-cb-06-bf-83', device_type_id: 3)
Device.create(name: 'SCv2020 SSN 216730', ip: '192.168.53.40', mac: '00-50-cc-7c-b2-20', description: 'SSN 216730 / iSCSI FD1 10.0.0.40 / FD2 10.0.53.40', device_type_id: 8)
Device.create(name: 'PS6000 Group', ip: '192.168.53.50', mac: '00-09-8a-08-4a-f2', description: 'iSCSI IP 10.0.53.50', device_type_id: 9)
