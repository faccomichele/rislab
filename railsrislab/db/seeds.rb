...
ot01 = OsType.create(name: 'Windows Server 2012')
ot02 = OsType.create(name: 'Windows Server 2012 R2')
ot03 = OsType.create(name: 'Windows Server 2016')
ot04 = OsType.create(name: 'ESXi 6.0')
ot05 = OsType.create(name: 'ESXi 6.5')
ot06 = OsType.create(name: 'none')
